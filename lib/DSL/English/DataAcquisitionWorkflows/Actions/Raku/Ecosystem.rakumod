...
#==============================================================================
#
#   Data Acquisition Workflows Raku-Ecosystem actions in Raku (Perl 6)
...
class DSL::English::DataAcquisitionWorkflows::Actions::Raku::Ecosystem
    ...
    method random-tabular-data-generation-command($/) {
        ...
        if $<random-tabular-dataset-arguments-list> {
            ...
            %allArgs = %( NumberOfRows => 'Whatever', NumberOfColumns => 'Whatever' ) , %allArgs;
            ...
            make 'random-tabular-dataset(' ~ %allArgs<NumberOfRows> ~ ', ' ~ %allArgs<NumberOfColumns> ~ $opts ~ ')';
        } else {
            make 'random-tabular-dataset()';
        }
    }
    ...
    method random-tabular-dataset-max-number-of-values-spec($/) { make %( MaxNumberOfValues => 'max-number-of-values => ' ~ $/.values[0].made ); }

    method random-tabular-dataset-min-number-of-values-spec($/) { make %( MinNumberOfValues => 'min-number-of-values => ' ~ $/.values[0].made ); }
